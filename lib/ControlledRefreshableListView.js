...
const REFRESHING_INDICATOR_HEIGHT = 180
...
console.log("content inset and indicator height", this.lastContentInsetTop)
        scrollToCompat(
          this.getScrollResponder(),
          -( REFRESHING_INDICATOR_HEIGHT),
...
console.log("content inset", this.lastContentInsetTop)
        scrollToCompat(
          this.getScrollResponder(),
